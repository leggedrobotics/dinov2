...
echo $pwd
experiment=vitl14_data_all_distill_multi_resnet18_34_50_625k_webd_bs_2048

# Run the training script inside the container
srun python -m dinov2.train.train_distill_convnet_multi \
  --exp-name ${experiment} \
  --config-file dinov2/configs/train/vitl14_distill_conv_multi_2048.yaml \
