...
root_src_dir = "/cluster/scratch/patelm/imagenet-1k-depth-anything-v2"
# root_tgt_dir = f"/media/patelm/ssd/imagenet-1k-dav2"
# root_src_dir = "/media/patelm/ssd/imagenet-1k-depth-anything-v2"


train_tar_files = [
    "train_images_0_npz.tar.gz",
    "train_images_1_npz.tar.gz",
    "train_images_2_npz.tar.gz",
    "train_images_3_npz.tar.gz",
    "train_images_4_npz.tar.gz",
]
val_tar_file = os.path.join(root_src_dir, "val_images_npz.tar.gz")
test_tar_file = os.path.join(root_src_dir, "test_images_npz.tar.gz")
...
train_images = glob(os.path.join(train_dir, '**', "*.npz"), recursive=True)
...
for image_path in train_images:
    ...
    new_filename = filename.rsplit('_', 1)[0] + ".npz"  # Keep only the first part
...
val_images = glob(os.path.join(val_dir, '**', "*.npz"), recursive=True)
