...
from .datasets import ImageNet, ImageNet22k, ImageNetDepth, GFMDataset,WebDatasetVisionPNG, WebDatasetVision, WebDatasetVisionRange, WebDatasetVisionPNGv1
...
def _parse_dataset_str(dataset_str: str):
    ...
    elif name == "ImageNetDepth":
        class_ = ImageNetDepth
        if "split" in kwargs:
            kwargs["split"] = ImageNetDepth.Split[kwargs["split"]]
    ...
    elif name == "WebDatasetVisionPNGv1":
        class_ = WebDatasetVisionPNGv1
    elif name == "WebDatasetVisionRange":
        class_ = WebDatasetVisionRange
    else:
...
def make_dataset(
    *,
    ...
    dataset = class_(transform=transform, target_transform=target_transform, dataset_list_file=dataset_list_file, **kwargs)
